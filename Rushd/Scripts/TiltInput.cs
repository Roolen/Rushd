...
// helps with managing tilt input on mobile devices
    public class TiltInput : MonoBehaviour
    {
        ...
        private CrossPlatformInputManager.VirtualAxis mSteerAxis;
        ...
        private void OnEnable()
        {
            ...
            {
                mSteerAxis = new CrossPlatformInputManager.VirtualAxis(mapping.axisName);
                CrossPlatformInputManager.RegisterVirtualAxis(mSteerAxis);
            }
        }
